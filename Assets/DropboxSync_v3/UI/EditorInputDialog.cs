...
namespace DBXSync
{
    ...
    public class EditorInputDialog : EditorWindow
    {
        ...
        /// <returns></returns>
        public static void Show(string title, string description, Action<string> onSubmit, string inputText = "", string okButton = "OK", string cancelButton = "Cancel")
        {
